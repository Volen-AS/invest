  ...
  <div class="position_prim_action">
    <div class="row">
      <div class="col-lg-8 col-md-12 col-sm-12">
        <h2 class="name_title_replenishment">Сформувати заявку на виведення валюти</h2>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="RegisNumber" type="text" class="pos_input_replenishment" name="name" value="" required autofocus>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select name="paySystems" id="paySystems">
                                  ...
                                  <option value="">Advanced Cash</option>
                                  <option value="">Payeer</option>
                                  <option value="">PayPal</option>
                                  <option value="">SolidTrustPay</option>
