 <div class="chat_cabinet">
    <h4>Чат рефкоманди</h4>
     <ul class="shoutbox-content" id="chat_messegde" data-my_chat_data="{{auth()->user()->getChat_id()->chat_id}}">
                 ...
                 @if($chat_messegde-> getTable() =='privet_messegdes')
                     ...
                     @if($chat_messegde->chat_id == auth()->user()->getChat_id()->chat_id)
                         ...
                         @if($chat_messegde->u_id == Auth::id())
                             <div class="choose_chat_id" data-message_id="{{$chat_messegde->message_id}}" data-choose_chat_id="{{$chat_messegde->chat_id}}">
                         ...
                         @else
                             {{--                            my chat msg to me--}}
                             <div class="choose_chat_id" data-chat_user_id="{{$chat_messegde->u_id}}" data-message_id="{{$chat_messegde->message_id}}" data-choose_chat_id="{{$chat_messegde->chat_id}}">
